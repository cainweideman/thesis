...
tokenizer = AutoTokenizer.from_pretrained('D:/scriptie/balanced_bertje/fine-tuned-bertje')
model = AutoModelForSequenceClassification.from_pretrained('D:/scriptie/balanced_bertje/fine-tuned-bertje', label2id={'1': 1, '0': 0}, id2label={1: '1', 0: '0'})
...
with open("D:/scriptie/balanced_bertje/probs/bertje_scores.pkl", "wb") as outfile:
	pickle.dump(prob_dict, outfile)

with open("D:/scriptie/balanced_bertje/probs/bertje_labels.pkl", "wb") as f:
