...
tokenizer = AutoTokenizer.from_pretrained('D:/scriptie/balanced_robbert/fine-tuned-robbert')
model = AutoModelForSequenceClassification.from_pretrained('D:/scriptie/balanced_robbert/fine-tuned-robbert', label2id={'1': 1, '0': 0}, id2label={1: '1', 0: '0'})
...
with open("D:/scriptie/balanced_robbert/probs/robbert_scores.pkl", "wb") as outfile:
	pickle.dump(prob_dict, outfile)

with open("D:/scriptie/balanced_robbert/probs/robbert_labels.pkl", "wb") as f:
