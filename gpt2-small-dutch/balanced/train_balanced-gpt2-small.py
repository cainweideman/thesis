...
training_args = TrainingArguments(
    output_dir='D:/scriptie/balanced_gpt2-small/output',
    logging_dir='logs',
    learning_rate=5e-5,
...
# Save the model
model.save_pretrained('D:/scriptie/balanced_gpt2-small/fine-tuned-gpt2-small')
tokenizer.save_pretrained('D:/scriptie/balanced_gpt2-small/fine-tuned-gpt2-small')