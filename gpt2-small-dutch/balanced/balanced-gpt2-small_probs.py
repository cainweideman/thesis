...
tokenizer = AutoTokenizer.from_pretrained('D:/scriptie/balanced_gpt2-small/fine-tuned-gpt2-small')
model = AutoModelForSequenceClassification.from_pretrained('D:/scriptie/balanced_gpt2-small/fine-tuned-gpt2-small', label2id={'1': 1, '0': 0}, id2label={1: '1', 0: '0'})
...
with open("D:/scriptie/balanced_gpt2-small/probs/gpt2-small_scores.pkl", "wb") as outfile:
	pickle.dump(prob_dict, outfile)

with open("D:/scriptie/balanced_gpt2-small/probs/gpt2-small_labels.pkl", "wb") as f:
