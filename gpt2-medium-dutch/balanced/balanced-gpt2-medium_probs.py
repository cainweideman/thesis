...
tokenizer = AutoTokenizer.from_pretrained('D:/scriptie/balanced_gpt2-medium/fine-tuned-gpt2-medium')
model = AutoModelForSequenceClassification.from_pretrained('D:/scriptie/balanced_gpt2-medium/fine-tuned-gpt2-medium', label2id={'1': 1, '0': 0}, id2label={1: '1', 0: '0'})
...
with open("D:/scriptie/balanced_gpt2-medium/probs/gpt2-medium_scores.pkl", "wb") as outfile:
	pickle.dump(prob_dict, outfile)

with open("D:/scriptie/balanced_gpt2-medium/probs/gpt2-medium_labels.pkl", "wb") as f:
