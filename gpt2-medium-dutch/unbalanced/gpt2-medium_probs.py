...
tokenizer = AutoTokenizer.from_pretrained('D:/scriptie/gpt2-medium-dutch/fine-tuned-gpt2-medium')
#tokenizer.padding_side = 'left'
#tokenizer.pad_token = tokenizer.eos_token

model = AutoModelForSequenceClassification.from_pretrained('D:/scriptie/gpt2-medium-dutch/fine-tuned-gpt2-medium', label2id={'1': 1, '0': 0}, id2label={1: '1', 0: '0'})
...
with open("D:/scriptie/gpt2-medium-dutch/probs/gpt2-medium_scores.pkl", "wb") as outfile:
	pickle.dump(prob_dict, outfile)

with open("D:/scriptie/gpt2-medium-dutch/probs/gpt2-medium_labels.pkl", "wb") as f:
